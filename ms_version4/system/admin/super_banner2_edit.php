...
{
$superbanner2=getSupperBanner2($superbanner_id);
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                        <form action="super_banner2_save.php" method="post" enctype="multipart/form-data">
                        <input name="superbanner_id" type="hidden" value="<?php echo $superbanner_id ?>">
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <label>Super Banner Name</label>
                                <input type="text" class="form-control" value="<?php echo $superbanner2['superbanner_name'] ?>" placeholder="Super Banner Name" name="superbanner_name">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                ?>
                                <option <?php echo $super['subcategory_id'] == $superbanner2['supercategory_id']? 'selected="selected"' : '' ?> value="<?php echo $super['subcategory_id'] ?>"><?php echo $super['subcategory_name'] ?></option>
                                <?php } ?>
                                </select>
                            </div>
