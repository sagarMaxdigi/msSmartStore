                    ...
                    <div class="box">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            foreach ($areas as $area) {
                                extract($area);
                            $city_name = getCity($area_city_id);
                            extract($city_name);
                            ?>
                            
                                <tr>
                                    <td><?php echo $area_id;  ?></td>
                                    <td><?php echo ucfirst($area_name); ?></td>
                                    ...
                                    <a href="javascript:void(0)" onClick="deleteentry(<?php echo $area_id?>)" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                                </tr>                                
