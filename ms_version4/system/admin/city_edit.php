                    ...
                    <div class="box">
                        ...
                        <div class="row">
                        	<div class="form-group col-sm-6">
                                <label>City</label>
                            	<input type="text" value="<?php echo $city_name ?>" class="form-control" placeholder="City Name" name="city_name">
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="clearfix"></div>
                        <div class="form-group col-sm-6">
                            <input type="submit" class="btn btn-success" value="update City">
                            </div>
                            </form>
                        </div><!-- /.box-body -->
                    </div><!-- /.box -->
