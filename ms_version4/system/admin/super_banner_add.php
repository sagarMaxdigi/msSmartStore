            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                        <form action="super_banner_save.php" method="post" enctype="multipart/form-data">
                        
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <label>Super Banner Name</label>
                                <input type="text" class="form-control" placeholder="Super Banner Name" name="superbanner_name">
                            </div>
